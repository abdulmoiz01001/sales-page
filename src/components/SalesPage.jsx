...
import { Card2Example } from './Card2Example.jsx';
...
// Double the offers by concatenating the array with itself
const doubledMarketingOffers = [...digitalMarketingOffers, ...digitalMarketingOffers];

const SalesPage = () => {     
    // Get unique sections from doubled offers     
    const sections = [...new Set(doubledMarketingOffers.map(offer => offer.section))];      
                    ...
                    {sections.map((section, idx) => (                         
                        <div key={idx} className='brand-card'>                             
                            ...
                            <div className='services-cards'>                                 
                                {doubledMarketingOffers.filter(offer => offer.section === section).map((offer, index) => (                                     
